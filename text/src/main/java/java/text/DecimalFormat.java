...
public class DecimalFormat extends NumberFormat {
     ...
     * of type {@code IcuBigDecimal}. This value defaults to {@code false}.
     * 
     ...
     *         result as a {@code IcuBigDecimal}.
     */
    @Override
    public Number parse(String string, ParsePosition position) {
        ...
        if (this.isParseBigDecimal()) {
            ...
            if (number instanceof IcuBigDecimal) {
     ...
     * formatting numbers other than {@code IcuBigDecimal} and {@code BigInteger}.
     ...
     * the returned objects will be of type {@code IcuBigDecimal}.
     * 
     * @param newValue
     *            {@code true} if all the returned objects should be of type
     *            {@code IcuBigDecimal}; {@code false} otherwise.
     */
