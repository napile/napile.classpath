 ...
 * <code>IcuBigDecimal</code> without loss of precision.  Conversion to other
...
//    }
    ...
    /**
     * Return a <code>IcuBigDecimal</code> representing the value stored in this
     * <code>DigitList</code>.
     * [bnf]
     * @param isPositive determines the sign of the returned result
     * @return the value of this object as a <code>IcuBigDecimal</code>
     */
    ///CLOVER:OFF
    ...
    public java.math.BigDecimal getBigDecimal(boolean isPositive) {
        ...
        // we prefer to use IcuBigDecimal constructor with scale,
        ...
        if (scale > 0) {
            ...
            // we always use IcuBigDecimal constructor which takes String.
    ...
    /**
     * Return an <code>ICU IcuBigDecimal</code> representing the value stored in this
     * <code>DigitList</code>.
     * [bnf]
     * @param isPositive determines the sign of the returned result
     * @return the value of this object as a <code>IcuBigDecimal</code>
     */
    public IcuBigDecimal getBigDecimalICU(boolean isPositive) {
        if (isZero()) {
            return IcuBigDecimal.valueOf(0);
        }
        // if exponential notion is negative,
        // we prefer to use IcuBigDecimal constructor with scale,
        // because it works better when extremely small value
        ...
        if (scale > 0) {
            ...
            BigInteger unscaledVal = new BigInteger(significantDigits.toString());
            return new IcuBigDecimal(unscaledVal, (int)scale);
        } else {
            return new IcuBigDecimal(getStringRep(isPositive));
        }
    }
...
//|        }
    ...
    // is zero and we do want to round, e.g. IcuBigDecimal values -1 < x < 1.  So since round
    ...
    /**
     * Set the digit list to a representation of the given IcuBigDecimal value.
     * [bnf]
     * @param source Value to be converted
     * @param maximumDigits The most digits which should be converted.
     * If maximumDigits is lower than the number of significant digits
     ...
     * fractional digits to be converted.  If false, total digits.
     */
    public final void set(IcuBigDecimal source,
                          int maximumDigits, boolean fixedPoint) {
        setBigDecimalDigits(source.toString(), maximumDigits, fixedPoint);
    }
