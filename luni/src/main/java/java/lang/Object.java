...
public class Object
{
	 ...
	 *
	 * @throws Throwable any exception which is raised during finalization; these are
	 ...
	 * </ul>
	 *
	 * @throws IllegalMonitorStateException if the thread calling this method is not the owner of this
	 *                                      object's monitor.
	 * @see #notify
	 * @see #wait()
	 * @see #wait(long)
	 ...
	 *
	 * @param millis the maximum time to wait in milliseconds.
	 * @param nanos  the fraction of a millisecond to wait, specified in
	 *               nanoseconds.
	 * @throws IllegalArgumentException     if {@code millis < 0}, {@code nanos < 0} or {@code nanos >
	 *                                      999999}.
	 * @throws IllegalMonitorStateException if the thread calling this method is not the owner of this
	 *                                      object's monitor.
	 * @throws InterruptedException         if another thread interrupts this thread while it is waiting.
