...
/* ------------------------------------------------------------------ */
/* IcuBigDecimal -- Decimal arithmetic for Java                          */
/* ------------------------------------------------------------------ */
/* Copyright IBM Corporation, 1996-2011.  All Rights Reserved.       */
/*                                                                    */
/* The IcuBigDecimal class provides immutable arbitrary-precision        */
/* floating point (including integer) decimal numbers.                */
/*                                                                    */
/* As the numbers are decimal, there is an exact correspondence       */
/* between an instance of a IcuBigDecimal object and its String          */
/* representation; the IcuBigDecimal class provides direct conversions   */
...
/* Notes:                                                             */
/*                                                                    */
/* 1. A IcuBigDecimal object is never changed in value once constructed; */
/*    this avoids the need for locking.  Note in particular that the  */
/*    mantissa array may be shared between many IcuBigDecimal objects,   */
...
/* 1998.06.25 rename to IcuBigDecimal and begin merge                    */
...
/* 1998.07.07 scaled division  [divide(IcuBigDecimal, int, int)]         */
...
/* 2000.06.18 1.08 no longer deprecate IcuBigDecimal(double)             */
/* ------------------------------------------------------------------ */

/**
 * The <code>IcuBigDecimal</code> class implements immutable arbitrary-precision decimal numbers. The methods of the
 * <code>IcuBigDecimal</code> class provide operations for fixed and floating point arithmetic, comparison, format
 * conversions, and hashing.
 * <p>
 * As the numbers are decimal, there is an exact correspondence between an instance of a <code>IcuBigDecimal</code> object
 * and its <code>String</code> representation; the <code>IcuBigDecimal</code> class provides direct conversions to and from
 ...
 * <p>
 * In the descriptions of constructors and methods in this documentation, the value of a <code>IcuBigDecimal</code> number
 ...
 * <p>
 * Operations on <code>IcuBigDecimal</code> numbers are controlled by a {@link MathContext} object, which provides the
 * context (precision and other information) for the operation. Methods that can take a <code>MathContext</code>
 * parameter implement the standard arithmetic operators for <code>IcuBigDecimal</code> objects and are known as
 ...
 * unlimited precision, as defined for the original IcuBigDecimal class in Java 1.1 and Java 1.2.
 * <p>
 * For monadic operators, only the optional <code>MathContext</code> parameter is present; the operation acts upon the
 * current object.
 * <p>
 * For dyadic operators, a <code>IcuBigDecimal</code> parameter is always present; it must not be <code>null</code>. The
 * operation acts with the current object being the left-hand operand and the <code>IcuBigDecimal</code> parameter being
 * the right-hand operand.
 * <p>
 * For example, adding two <code>IcuBigDecimal</code> objects referred to by the names <code>award</code> and
 ...
 * </code>
 * <p>
 * (where <code>acontext</code> is a <code>MathContext</code> object), which would return a <code>IcuBigDecimal</code>
 * object whose value is the result of adding <code>award</code> and <code>extra</code> under the appropriate context
 * settings.
 * <p>
 * When a <code>IcuBigDecimal</code> operator method is used, a set of rules define what the result will be (and, by
 * implication, how the result would be represented as a character string). These rules are defined in the IcuBigDecimal
 ...
 * <p>
 * <code>
 *     new IcuBigDecimal("2.40").add(     new IcuBigDecimal("2"))      =&gt; "4.40"
 * <br>new IcuBigDecimal("2.40").subtract(new IcuBigDecimal("2"))      =&gt; "0.40"
 * <br>new IcuBigDecimal("2.40").multiply(new IcuBigDecimal("2"))      =&gt; "4.80"
 * <br>new IcuBigDecimal("2.40").divide(  new IcuBigDecimal("2"), def) =&gt; "1.2"
 * </code>
 * <p>
 ...
 * <p>
 * <code>
 *   new IcuBigDecimal("1e+6").multiply(new IcuBigDecimal("1e+6"), def)
 * </code>
 * <p>
 * results in <code>1E+12</code> instead of <code>1000000000000</code>, and
 * <p>
 * <code>
 *   new IcuBigDecimal("1").divide(new IcuBigDecimal("3E+10"), def)
 * </code>
 * <p>
 ...
 * <code>java.math.BigInteger</code>, and <code>java.math.IcuBigDecimal</code> in Java 1.1 and Java 1.2.
 * 
 * @see MathContext
...
public class IcuBigDecimal extends java.lang.Number implements java.io.Serializable, java.lang.Comparable<IcuBigDecimal> {
    // private static final java.lang.String $0="IcuBigDecimal.nrx";

    /* ----- Constants ----- */
    /* properties constant public */// useful to others
    /**
     * The <code>IcuBigDecimal</code> constant "0".
     * 
     * @see #ONE
     * @see #TEN
     * @stable ICU 2.0
     */
    public static final IcuBigDecimal ZERO = new IcuBigDecimal((long) 0); // use long as we
                                                                                                      // want the int
                                                                                                      // constructor
    // .. to be able to use this, for speed

    /**
     * The <code>IcuBigDecimal</code> constant "1".
     * 
     * @see #TEN
     * @see #ZERO
     * @stable ICU 2.0
     */
    public static final IcuBigDecimal ONE = new IcuBigDecimal((long) 1); // use long as we
                                                                                                     // want the int
                                                                                                     // constructor
    // .. to be able to use this, for speed

    /**
     * The <code>IcuBigDecimal</code> constant "10".
     * 
     * @see #ONE
     * @see #ZERO
     * @stable ICU 2.0
     */
    public static final IcuBigDecimal TEN = new IcuBigDecimal(10);
     ...
     * <p>
     * Once constructed, this may become shared between several IcuBigDecimal objects, so must not be altered.
     * <p>
    ...
    /**
     * Constructs a <code>IcuBigDecimal</code> object from a <code>java.math.IcuBigDecimal</code>.
     * <p>
     * Constructs a <code>IcuBigDecimal</code> as though the parameter had been represented as a <code>String</code> (using
     * its <code>toString</code> method) and the {@link #IcuBigDecimal(java.lang.String)} constructor had then been used.
     * The parameter must not be <code>null</code>.
     * <p>
     * <i>(Note: this constructor is provided only in the <code>com.ibm.icu.math</code> version of the IcuBigDecimal class.
     * It would not be present in a <code>java.math</code> version.)</i>
     * 
     * @param bd The <code>IcuBigDecimal</code> to be translated.
     * @stable ICU 2.0
     */

    public IcuBigDecimal(IcuBigDecimal bd) {
        this(bd.toString());
        return;
    }

    /**
     * Constructs a <code>IcuBigDecimal</code> object from a <code>BigInteger</code>, with scale 0.
     * <p>
     * Constructs a <code>IcuBigDecimal</code> which is the exact decimal representation of the <code>BigInteger</code>,
     * with a scale of zero. The value of the <code>IcuBigDecimal</code> is identical to the value of the <code>BigInteger
     * </code>. The parameter must not be <code>null</code>.
     * <p>
     * The <code>IcuBigDecimal</code> will contain only decimal digits, prefixed with a leading minus sign (hyphen) if the
    ...
    public IcuBigDecimal(BigInteger bi) {
        this(bi.toString(10));
        return;
    }
    ...
    /**
     * Constructs a <code>IcuBigDecimal</code> object from a <code>BigInteger</code> and a scale.
     * <p>
     * Constructs a <code>IcuBigDecimal</code> which is the exact decimal representation of the <code>BigInteger</code>,
     * scaled by the second parameter, which may not be negative. The value of the <code>IcuBigDecimal</code> is the <code>
     * BigInteger</code> divided by ten to the power of the scale. The <code>BigInteger</code> parameter must not be
     * <code>null</code>.
     * <p>
     * The <code>IcuBigDecimal</code> will contain only decimal digits, (with an embedded decimal point followed by <code>
    ...
    public IcuBigDecimal(java.math.BigInteger bi, int scale) {
        this(bi.toString(10));
        if (scale < 0)
    ...
    /**
     * Constructs a <code>IcuBigDecimal</code> object from an array of characters.
     * <p>
     * Constructs a <code>IcuBigDecimal</code> as though a <code>String</code> had been constructed from the character
     * array and the {@link #IcuBigDecimal(java.lang.String)} constructor had then been used. The parameter must not be
     * <code>null</code>.
     * <p>
     * Using this constructor is faster than using the <code>IcuBigDecimal(String)</code> constructor if the string is
    ...
    public IcuBigDecimal(char inchars[]) {
     ...
     * <p>
     * Constructs a <code>IcuBigDecimal</code> as though a <code>String</code> had been constructed from the character
     * array (or a subarray of that array) and the {@link #IcuBigDecimal(java.lang.String)} constructor had then been used.
    ...
    public IcuBigDecimal(char inchars[], int offset, int length) {
        super();
        boolean exotic;
        boolean hadexp;
        int d;
    ...
    /**
     * Constructs a <code>IcuBigDecimal</code> object directly from a <code>double</code>.
     * <p>
     * Constructs a <code>IcuBigDecimal</code> which is the exact decimal representation of the 64-bit signed binary
     ...
     * {@link #IcuBigDecimal(java.lang.String)} constructor. To get that result, use the static {@link #valueOf(double)}
     * method to construct a <code>IcuBigDecimal</code> from a <code>double</code>.
     * 
    ...
    public IcuBigDecimal(double num) {
        ...
        this((new IcuBigDecimal(num)).toString());
        return;
    }

    /**
     * Constructs a <code>IcuBigDecimal</code> object directly from a <code>int</code>.
     * <p>
     * Constructs a <code>IcuBigDecimal</code> which is the exact decimal representation of the 32-bit signed binary
     * integer parameter. The <code>IcuBigDecimal</code> will contain only decimal digits, prefixed with a leading minus
    ...
    /**
     * Constructs a <code>IcuBigDecimal</code> object directly from a <code>long</code>.
     * <p>
     * Constructs a <code>IcuBigDecimal</code> which is the exact decimal representation of the 64-bit signed binary
     * integer parameter. The <code>IcuBigDecimal</code> will contain only decimal digits, prefixed with a leading minus
     * sign (hyphen) if the parameter is negative. A leading zero will be present only if the parameter is zero.
    ...
    /**
     * Constructs a <code>IcuBigDecimal</code> object from a <code>String</code>.
     * <p>
     * Constructs a <code>IcuBigDecimal</code> from the parameter, which must not be <code>null</code> and must represent a
     * valid <i>number</i>, as described formally in the documentation referred to {@link IcuBigDecimal above}.
     * <p>
     ...
     * <p>
     * Some valid strings from which a <code>IcuBigDecimal</code> might be constructed are:
     * 
     * <pre>
     * 
     ...
     * 0.000000073</code>.)
     * <p>
     * The <code>IcuBigDecimal</code> constructed from the String is in a standard form, with no blanks, as though the
     * {@link #add(IcuBigDecimal)} method had been used to add zero to the number with unlimited precision. If the string
     * uses exponential notation (that is, includes an <code>e</code> or an <code>E</code>), then the <code>IcuBigDecimal
    ...
    public IcuBigDecimal(java.lang.String string) {
        this(string.toCharArray(), 0, string.length());
        return;
    }

    /* <sgml> Make a default IcuBigDecimal object for local use. </sgml> */

    private IcuBigDecimal() {
        super();
        return;
    }
    ...
    /**
     * Returns a plain <code>IcuBigDecimal</code> whose value is the absolute value of this <code>IcuBigDecimal</code>.
     * <p>
     ...
     * 
     * @return A <code>IcuBigDecimal</code> whose value is the absolute value of this <code>IcuBigDecimal</code>.
     * @stable ICU 2.0
     */

    public IcuBigDecimal abs() {
        return this.abs(plainMC);
    }

    /**
     * Returns a <code>IcuBigDecimal</code> whose value is the absolute value of this <code>IcuBigDecimal</code>.
     * <p>
    ...
    public IcuBigDecimal abs(com.ibm.icu.math.MathContext set) {
        if (this.ind == isneg)
    ...
    /**
     * Returns a plain <code>IcuBigDecimal</code> whose value is <code>this+rhs</code>, using fixed point arithmetic.
     * <p>
     * The same as {@link #add(IcuBigDecimal, MathContext)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>, and the
     ...
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the addition.
     * @return A <code>IcuBigDecimal</code> whose value is <code>this+rhs</code>, using fixed point arithmetic.
     * @stable ICU 2.0
     */

    public IcuBigDecimal add(IcuBigDecimal rhs) {
        return this.add(rhs, plainMC);
    }

    /**
     * Returns a <code>IcuBigDecimal</code> whose value is <code>this+rhs</code>.
     * <p>
     * Implements the addition (<b><code>+</code></b>) operator (as defined in the decimal documentation, see
     * {@link IcuBigDecimal class header}), and returns the result as a <code>IcuBigDecimal</code> object.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the addition.
     * @param set The <code>MathContext</code> arithmetic settings.
     * @return A <code>IcuBigDecimal</code> whose value is <code>this+rhs</code>.
     * @stable ICU 2.0
     */

    public IcuBigDecimal add(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
        IcuBigDecimal lhs;
        int reqdig;
        IcuBigDecimal res;
        byte usel[];
        ...
        res = new IcuBigDecimal(); // build result here
    ...
    /**
     * Compares this <code>IcuBigDecimal</code> to another, using unlimited precision.
     * <p>
     * The same as {@link #compareTo(IcuBigDecimal, MathContext)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>,
     * and the context is <code>new MathContext(0, MathContext.PLAIN)</code>.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the comparison.
    ...
    public int compareTo(IcuBigDecimal rhs) {
        return this.compareTo(rhs, plainMC);
    }

    /**
     * Compares this <code>IcuBigDecimal</code> to another.
     * <p>
     * Implements numeric comparison, (as defined in the decimal documentation, see {@link IcuBigDecimal class header}),
     ...
     * </table>
     * <p>
     * A {@link #compareTo(IcuBigDecimal)} method is also provided.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the comparison.
     * @param set The <code>MathContext</code> arithmetic settings.
     * @return An <code>int</code> whose value is -1, 0, or 1 as <code>this</code> is numerically less than, equal to,
    ...
    public int compareTo(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
        int thislength = 0;
        int i = 0;
        IcuBigDecimal newrhs;
     ...
     * Returns a plain <code>IcuBigDecimal</code> whose value is <code>this/rhs</code>, using fixed point arithmetic.
     * <p>
     * The same as {@link #divide(IcuBigDecimal, int)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>, and the
     ...
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the division.
     * @return A plain <code>IcuBigDecimal</code> whose value is <code>this/rhs</code>, using fixed point arithmetic.
     * @throws ArithmeticException If <code>rhs</code> is zero.
     * @stable ICU 2.0
     */

    public IcuBigDecimal divide(IcuBigDecimal rhs) {
        return this.dodivide('D', rhs, plainMC, -1);
    }

    /**
     * Returns a plain <code>IcuBigDecimal</code> whose value is <code>this/rhs</code>, using fixed point arithmetic and a
     * rounding mode.
     * <p>
     * The same as {@link #divide(IcuBigDecimal, int, int)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>, and the
     ...
     * @return A plain <code>IcuBigDecimal</code> whose value is <code>this/rhs</code>, using fixed point arithmetic and
    ...
    public IcuBigDecimal divide(IcuBigDecimal rhs, int round) {
     ...
     * <p>
     * The same as {@link #divide(IcuBigDecimal, MathContext)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>,
    ...
    public IcuBigDecimal divide(IcuBigDecimal rhs, int scale, int round) {
        com.ibm.icu.math.MathContext set;
        if (scale < 0)
    ...
    public IcuBigDecimal divide(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
        return this.dodivide('D', rhs, set, -1);
    }

    /**
     * Returns a plain <code>IcuBigDecimal</code> whose value is the integer part of <code>this/rhs</code>.
     * <p>
     * The same as {@link #divideInteger(IcuBigDecimal, MathContext)}, where the <code>IcuBigDecimal</code> is <code>rhs
     * </code>, and the context is <code>new MathContext(0, MathContext.PLAIN)</code>.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the integer division.
     * @return A <code>IcuBigDecimal</code> whose value is the integer part of <code>this/rhs</code>.
     * @throws ArithmeticException if <code>rhs</code> is zero.
     * @stable ICU 2.0
     */

    public IcuBigDecimal divideInteger(IcuBigDecimal rhs) {
        // scale 0 to drop .000 when plain
        return this.dodivide('I', rhs, plainMC, 0);
    }

    /**
     * Returns a <code>IcuBigDecimal</code> whose value is the integer part of <code>this/rhs</code>.
     * <p>
     * Implements the integer division operator (as defined in the decimal documentation, see {@link IcuBigDecimal class
     * header}), and returns the result as a <code>IcuBigDecimal</code> object.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the integer division.
     * @param set The <code>MathContext</code> arithmetic settings.
     * @return A <code>IcuBigDecimal</code> whose value is the integer part of <code>this/rhs</code>.
    ...
    public IcuBigDecimal divideInteger(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
        // scale 0 to drop .000 when plain
        return this.dodivide('I', rhs, set, 0);
    }

    /**
     * Returns a plain <code>IcuBigDecimal</code> whose value is the maximum of <code>this</code> and <code>rhs</code>.
     * <p>
     * The same as {@link #max(IcuBigDecimal, MathContext)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>, and the
     * context is <code>new MathContext(0, MathContext.PLAIN)</code>.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the comparison.
     * @return A <code>IcuBigDecimal</code> whose value is the maximum of <code>this</code> and <code>rhs</code>.
     * @stable ICU 2.0
     */

    public IcuBigDecimal max(IcuBigDecimal rhs) {
        return this.max(rhs, plainMC);
    }

    /**
     * Returns a <code>IcuBigDecimal</code> whose value is the maximum of <code>this</code> and <code>rhs</code>.
     * <p>
     * Returns the larger of the current object and the first parameter.
     * <p>
     * If calling the {@link #compareTo(IcuBigDecimal, MathContext)} method with the same parameters would return <code>1
    ...
    public IcuBigDecimal max(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
    ...
    /**
     * Returns a plain <code>IcuBigDecimal</code> whose value is the minimum of <code>this</code> and <code>rhs</code>.
     * <p>
     * The same as {@link #min(IcuBigDecimal, MathContext)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>, and the
     * context is <code>new MathContext(0, MathContext.PLAIN)</code>.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the comparison.
     * @return A <code>IcuBigDecimal</code> whose value is the minimum of <code>this</code> and <code>rhs</code>.
     * @stable ICU 2.0
     */

    public IcuBigDecimal min(IcuBigDecimal rhs) {
        return this.min(rhs, plainMC);
    }

    /**
     * Returns a <code>IcuBigDecimal</code> whose value is the minimum of <code>this</code> and <code>rhs</code>.
     * <p>
    ...
    public IcuBigDecimal min(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
        if ((this.compareTo(rhs, set)) <= 0)
            return this.plus(set);
        else
            return rhs.plus(set);
     ...
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the multiplication.
     * @return A <code>IcuBigDecimal</code> whose value is <code>this*rhs</code>, using fixed point arithmetic.
     * @stable ICU 2.0
     */

    public IcuBigDecimal multiply(IcuBigDecimal rhs) {
    ...
    public IcuBigDecimal multiply(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
        IcuBigDecimal lhs;
        int padding;
        int reqdig;
        byte multer[] = null;
        ...
        res = new IcuBigDecimal(); // where we'll build result
    ...
    /**
     * Returns a plain <code>IcuBigDecimal</code> whose value is <code>-this</code>.
     * <p>
     ...
     * 
     * 
     * @return A <code>IcuBigDecimal</code> whose value is <code>-this</code>.
     * @stable ICU 2.0
     */

    public IcuBigDecimal negate() {
        return this.negate(plainMC);
    }

    /**
     * Returns a <code>IcuBigDecimal</code> whose value is <code>-this</code>.
     * <p>
    ...
    /**
     * Returns a plain <code>IcuBigDecimal</code> whose value is <code>+this</code>. Note that <code>this</code> is not
     * necessarily a plain <code>IcuBigDecimal</code>, but the result will always be.
     * <p>
    ...
    public IcuBigDecimal plus(com.ibm.icu.math.MathContext set) {
     ...
     * Returns a plain <code>IcuBigDecimal</code> whose value is <code>this**rhs</code>, using fixed point arithmetic.
     * <p>
     * The same as {@link #pow(IcuBigDecimal, MathContext)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>, and the
     * context is <code>new MathContext(0, MathContext.PLAIN)</code>.
     * <p>
     ...
     * always be 0.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the operation (the power).
     * @return A <code>IcuBigDecimal</code> whose value is <code>this**rhs</code>, using fixed point arithmetic.
     * @throws ArithmeticException if <code>rhs</code> is out of range or is not a whole number.
     * @stable ICU 2.0
     */

    public IcuBigDecimal pow(IcuBigDecimal rhs) {
    ...
    public IcuBigDecimal pow(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
        int n;
        IcuBigDecimal lhs;
        int reqdig;
        int workdigits = 0;
    ...
    /**
     * Returns a plain <code>IcuBigDecimal</code> whose value is the remainder of <code>this/rhs</code>, using fixed point
     * arithmetic.
     * <p>
     * The same as {@link #remainder(IcuBigDecimal, MathContext)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>,
     * and the context is <code>new MathContext(0, MathContext.PLAIN)</code>.
     * <p>
     * This is not the modulo operator -- the result may be negative.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the remainder operation.
     * @return A <code>IcuBigDecimal</code> whose value is the remainder of <code>this/rhs</code>, using fixed point
     *         arithmetic.
     * @throws ArithmeticException if <code>rhs</code> is zero.
     * @stable ICU 2.0
     */

    public IcuBigDecimal remainder(IcuBigDecimal rhs) {
        return this.dodivide('R', rhs, plainMC, -1);
    }

    /**
     * Returns a <code>IcuBigDecimal</code> whose value is the remainder of <code>this/rhs</code>.
     * <p>
     * Implements the remainder operator (as defined in the decimal documentation, see {@link IcuBigDecimal class header}),
     * and returns the result as a <code>IcuBigDecimal</code> object.
     * <p>
     * This is not the modulo operator -- the result may be negative.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the remainder operation.
     * @param set The <code>MathContext</code> arithmetic settings.
     * @return A <code>IcuBigDecimal</code> whose value is the remainder of <code>this+rhs</code>.
     * @throws ArithmeticException if <code>rhs</code> is zero.
    ...
    public IcuBigDecimal remainder(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
     ...
     * Returns a plain <code>IcuBigDecimal</code> whose value is <code>this-rhs</code>, using fixed point arithmetic.
     * <p>
     * The same as {@link #subtract(IcuBigDecimal, MathContext)}, where the <code>IcuBigDecimal</code> is <code>rhs</code>,
     * and the context is <code>new MathContext(0, MathContext.PLAIN)</code>.
     * <p>
     * The length of the decimal part (the scale) of the result will be the maximum of the scales of the two operands.
     * 
     * @param rhs The <code>IcuBigDecimal</code> for the right hand side of the subtraction.
     * @return A <code>IcuBigDecimal</code> whose value is <code>this-rhs</code>, using fixed point arithmetic.
     * @stable ICU 2.0
     */

    public IcuBigDecimal subtract(IcuBigDecimal rhs) {
    ...
    public IcuBigDecimal subtract(IcuBigDecimal rhs, com.ibm.icu.math.MathContext set) {
        IcuBigDecimal newrhs;
        if (set.lostDigits)
            checkdigits(rhs, set.digits);
    ...
    /**
     * Converts this <code>IcuBigDecimal</code> to a <code>byte</code>. If the <code>IcuBigDecimal</code> has a non-zero
    ...
    /**
     * Converts this <code>IcuBigDecimal</code> to a <code>double</code>. If the <code>IcuBigDecimal</code> is out of the
     * possible range for a <code>double</code> (64-bit signed floating point) result then an <code>ArithmeticException
     * </code> is thrown.
     * <p>
     * The double produced is identical to result of expressing the <code>IcuBigDecimal</code> as a <code>String</code> and
    ...
    public double doubleValue() {
        // We go via a String [as does IcuBigDecimal in JDK 1.2]
        // Next line could possibly raise NumberFormatException
        return java.lang.Double.valueOf(this.toString()).doubleValue();
    }

    /**
     * Compares this <code>IcuBigDecimal</code> with <code>rhs</code> for equality.
     * <p>
     * If the parameter is <code>null</code>, or is not an instance of the IcuBigDecimal type, or is not exactly equal to
     * the current <code>IcuBigDecimal</code> object, then <i>false</i> is returned. Otherwise, <i>true</i> is returned.
     * <p>
     * "Exactly equal", here, means that the <code>String</code> representations of the <code>IcuBigDecimal</code> numbers
     * are identical (they have the same characters in the same sequence).
     * <p>
     * The {@link #compareTo(IcuBigDecimal, MathContext)} method should be used for more general comparisons.
     * 
     ...
     *         representations.
     * @throws ClassCastException if <code>rhs</code> cannot be cast to a <code>IcuBigDecimal</code> object.
     * @stable ICU 2.0
     * @see #compareTo(IcuBigDecimal)
     * @see #compareTo(IcuBigDecimal, MathContext)
     */
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        if ((!(((obj instanceof IcuBigDecimal)))))
            return false; // not a decimal
        rhs = (IcuBigDecimal) obj; // cast; we know it will work
        if (this.ind != rhs.ind)
    ...
    /**
     * Converts this <code>IcuBigDecimal</code> to a <code>float</code>. If the <code>IcuBigDecimal</code> is out of the
     * possible range for a <code>float</code> (32-bit signed floating point) result then an <code>ArithmeticException
     * </code> is thrown.
     * <p>
     * The float produced is identical to result of expressing the <code>IcuBigDecimal</code> as a <code>String</code> and
    ...
    /**
     * Returns the <code>String</code> representation of this <code>IcuBigDecimal</code>, modified by layout parameters.
     * <p>
     ...
     * necessary part of the IcuBigDecimal class as it is sensitive to and must follow the calculation and rounding rules
     * for IcuBigDecimal arithmetic. However, if the function is provided elsewhere, it may be removed from this class.
     * </i>
     * <p>
     ...
     * @return A <code>String</code> representing this <code>IcuBigDecimal</code>, laid out according to the specified parameters
    ...
    /**
     * Returns the <code>String</code> representation of this <code>IcuBigDecimal</code>, modified by layout parameters and
     ...
     * @return A <code>String</code> representing this <code>IcuBigDecimal</code>, laid out according to the specified
     *         parameters
     * @throws ArithmeticException if the number cannot be laid out as requested.
     * @throws IllegalArgumentException if a parameter is out of range.
     * @see #toString
    ...
    public java.lang.String format(int before, int after, int explaces, int exdigits, int exformint, int exround) {
        ...
        /*
         * Here: num is IcuBigDecimal to format before is places before point [>0] after is places after point [>=0]
    ...
    /**
     * Returns the hashcode for this <code>IcuBigDecimal</code>. This hashcode is suitable for use by the <code>
     * java.util.Hashtable</code> class.
     * <p>
     * Note that two <code>IcuBigDecimal</code> objects are only guaranteed to produce the same hashcode if they are
     * exactly equal (that is, the <code>String</code> representations of the <code>IcuBigDecimal</code> numbers are
    ...
    /**
     * Converts this <code>IcuBigDecimal</code> to an <code>int</code>. If the <code>IcuBigDecimal</code> has a non-zero
     * decimal part it is discarded. If the <code>IcuBigDecimal</code> is out of the possible range for an <code>int</code>
    ...
    /**
     * Converts this <code>IcuBigDecimal</code> to a <code>long</code>. If the <code>IcuBigDecimal</code> has a non-zero
     * decimal part it is discarded. If the <code>IcuBigDecimal</code> is out of the possible range for a <code>long</code>
    ...
    /**
     * Returns a plain <code>IcuBigDecimal</code> whose decimal point has been moved to the left by a specified number of
     ...
     * <p>
     * <code> this.multiply(TEN.pow(new IcuBigDecimal(-n))) </code>
     * <p>
     ...
     * @return A <code>IcuBigDecimal</code> derived from <code>this</code>, with the decimal point moved <code>n</code>
     *         places to the left.
     * @stable ICU 2.0
     */

    public IcuBigDecimal movePointLeft(int n) {
        IcuBigDecimal res;
    ...
    /**
     * Returns a plain <code>IcuBigDecimal</code> whose decimal point has been moved to the right by a specified number of
     * positions. The parameter, <code>n</code>, specifies the number of positions to move the decimal point. That is,
     * if <code>n</code> is 0 or positive, the number returned is given by:
     * <p>
     * <code> this.multiply(TEN.pow(new IcuBigDecimal(n))) </code>
    ...
    public IcuBigDecimal movePointRight(int n) {
        IcuBigDecimal res;
        res = clone(this);
        res.exp = res.exp + n;
    ...
    /**
     * Returns the scale of this <code>IcuBigDecimal</code>. Returns a non-negative <code>int</code> which is the scale of
     * the number. The scale is the number of digits in the decimal part of the number if the number were formatted
     * without exponential notation.
     * 
     * @return An <code>int</code> whose value is the scale of this <code>IcuBigDecimal</code>.
     * @stable ICU 2.0
     */
    ...
    /**
     * Returns a plain <code>IcuBigDecimal</code> with a given scale.
     * <p>
     * If the given scale (which must be zero or positive) is the same as or greater than the length of the decimal part
     * (the scale) of this <code>IcuBigDecimal</code> then trailing zeros will be added to the decimal part as necessary.
     * <p>
     * If the given scale is less than the length of the decimal part (the scale) of this <code>IcuBigDecimal</code> then
     ...
     * 
     * @param scale The <code>int</code> specifying the scale of the resulting <code>IcuBigDecimal</code>.
     * @return A plain <code>IcuBigDecimal</code> with the given scale.
     * @throws ArithmeticException if <code>scale</code> is negative.
     * @throws ArithmeticException if reducing scale would discard non-zero digits.
     * @stable ICU 2.0
     */

    public IcuBigDecimal setScale(int scale) {
    ...
    public IcuBigDecimal setScale(int scale, int round) {
        int ourscale;
        IcuBigDecimal res;
        int padding = 0;
        int newlen = 0;
    ...
    /**
     * Converts this <code>IcuBigDecimal</code> to a <code>short</code>. If the <code>IcuBigDecimal</code> has a non-zero
    ...
    /**
     * Returns the sign of this <code>IcuBigDecimal</code>, as an <code>int</code>. This returns the <i>signum</i> function
     * value that represents the sign of this <code>IcuBigDecimal</code>. That is, -1 if the <code>IcuBigDecimal</code> is
     * negative, 0 if it is numerically equal to zero, or 1 if it is positive.
     * 
     * @return An <code>int</code> which is -1 if the <code>IcuBigDecimal</code> is negative, 0 if it is numerically equal
    ...
    /**
     * Converts this <code>IcuBigDecimal</code> to a <code>java.math.IcuBigDecimal</code>.
     * <p>
     * This is an exact conversion; the result is the same as if the <code>IcuBigDecimal</code> were formatted as a plain
     * number without any rounding or exponent and then the <code>java.math.IcuBigDecimal(java.lang.String)</code>
     * constructor were used to construct the result.
     * <p>
     * <i>(Note: this method is provided only in the <code>com.ibm.icu.math</code> version of the IcuBigDecimal class. It
     * would not be present in a <code>java.math</code> version.)</i>
     * 
     * @return The <code>java.math.IcuBigDecimal</code> equal in value to this <code>IcuBigDecimal</code>.
     * @stable ICU 2.0
     */
    ...
    /**
     * Converts this <code>IcuBigDecimal</code> to a <code>java.math.BigInteger</code>.
     * <p>
     ...
     * 
     * @return The <code>java.math.BigInteger</code> equal in value to the integer part of this <code>IcuBigDecimal</code>.
     * @stable ICU 2.0
     */

    public java.math.BigInteger toBigInteger() {
        IcuBigDecimal res = null;
        int newlen = 0;
        byte newmant[] = null;
        {/* select */
    ...
    /**
     * Returns the <code>IcuBigDecimal</code> as a character array. The result of this method is the same as using the
     * sequence <code>toString().toCharArray()</code>, but avoids creating the intermediate <code>String</code> and
     * <code>char[]</code> objects.
     * 
     * @return The <code>char[]</code> array corresponding to this <code>IcuBigDecimal</code>.
     * @stable ICU 2.0
     */
    ...
    /**
     * Returns the <code>IcuBigDecimal</code> as a <code>String</code>. This returns a <code>String</code> that exactly
     * represents this <code>IcuBigDecimal</code>, as defined in the decimal documentation (see {@link IcuBigDecimal class
     * header}).
     * <p>
     * By definition, using the {@link #IcuBigDecimal(String)} constructor on the result <code>String</code> will create a
     * <code>IcuBigDecimal</code> that is exactly equal to the original <code>IcuBigDecimal</code>.
     * 
     * @return The <code>String</code> exactly corresponding to this <code>IcuBigDecimal</code>.
     * @see #format(int, int)
     ...
     * 
     * @return The <code>java.math.BigInteger</code> equal in value to this <code>IcuBigDecimal</code> multiplied by ten to
    ...
    /**
     * Translates a <code>double</code> to a <code>IcuBigDecimal</code>.
     * <p>
     * Returns a <code>IcuBigDecimal</code> which is the decimal representation of the 64-bit signed binary floating point
     ...
     * Double.toString()</code> method and the {@link #IcuBigDecimal(java.lang.String)} constructor had then been used.
     * This is typically not an exact conversion.
     * 
     * @param dub The <code>double</code> to be translated.
     * @return The <code>IcuBigDecimal</code> equal in value to <code>dub</code>.
     * @throws NumberFormatException if the parameter is infinite or not a number.
     * @stable ICU 2.0
     */

    public static IcuBigDecimal valueOf(double dub) {
        ...
        return new IcuBigDecimal((new java.lang.Double(dub)).toString());
    }

    /**
     * Translates a <code>long</code> to a <code>IcuBigDecimal</code>. That is, returns a plain <code>IcuBigDecimal</code>
     * whose value is equal to the given <code>long</code>.
     * 
     * @param lint The <code>long</code> to be translated.
     * @return The <code>IcuBigDecimal</code> equal in value to <code>lint</code>.
     * @stable ICU 2.0
     */

    public static IcuBigDecimal valueOf(long lint) {
        return valueOf(lint, 0);
    }

    /**
     * Translates a <code>long</code> to a <code>IcuBigDecimal</code> with a given scale. That is, returns a plain <code>
     * IcuBigDecimal</code> whose unscaled value is equal to the given <code>long</code>, adjusted by the second parameter,
     * <code>scale</code>.
     * <p>
     * The result is given by:
     * <p>
     * <code> (new IcuBigDecimal(lint)).divide(TEN.pow(new IcuBigDecimal(scale))) </code>
     * <p>
    ...
    public static IcuBigDecimal valueOf(long lint, int scale) {
        IcuBigDecimal res = null;
        {/* select */
            if (lint == 0)
                res = ZERO;
    ...
    /*
     * <sgml> Return char array value of a IcuBigDecimal (conversion from IcuBigDecimal to laid-out canonical char array).
    ...
    /*
     * <sgml> Checks a IcuBigDecimal argument to ensure it's a true integer in a given range. <p>If OK, returns it as an
     * int. </sgml>
     */
    ...
    private IcuBigDecimal dodivide(char code, IcuBigDecimal rhs,
        ...
        /* Prepare numbers according to IcuBigDecimal rules */
        reqdig = set.digits; // local copy (heavily used)
        if (reqdig > 0) {
            if (lhs.mant.length > reqdig)
                lhs = clone(lhs).round(set);
    ...
    /*
     * <sgml> Create a copy of IcuBigDecimal object for local use. <p>This does NOT make a copy of the mantissa array.
     * </sgml> Arg1 is the IcuBigDecimal to clone (non-null)
     */

    private static final IcuBigDecimal clone(IcuBigDecimal dec) {
        IcuBigDecimal copy;
        copy = new IcuBigDecimal();
        copy.ind = dec.ind;
        copy.exp = dec.exp;
        copy.form = dec.form;
        copy.mant = dec.mant;
    ...
    private void checkdigits(IcuBigDecimal rhs, int dig) {
        if (dig == 0)
    ...
    private IcuBigDecimal round(com.ibm.icu.math.MathContext set) {
    ...
    private IcuBigDecimal round(int len, int mode) {
        int adjust;
        int sign;
        byte oldmant[];
        boolean reuse = false;
    ...
    private IcuBigDecimal finish(com.ibm.icu.math.MathContext set, boolean strip) {
        int d = 0;
        int i = 0;
        byte newmant[] = null;
        int mag = 0;
