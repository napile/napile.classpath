...
public abstract class NumberFormat extends UFormat {
     ...
     * and <code>IcuBigDecimal</code> objects.
    ...
    public StringBuffer format(Object number,
        ...
        } else if (number instanceof IcuBigDecimal) {
            return format((IcuBigDecimal) number, toAppendTo, pos);
    ...
    /**
     * Convenience method to format a IcuBigDecimal.
     * @stable ICU 2.0
     */
    ...
    /**
     * {@icu} Convenience method to format an ICU IcuBigDecimal.
     * @stable ICU 2.0
     */
    public final String format(IcuBigDecimal number) {
        return format(number, new StringBuffer(),
                      new FieldPosition(0)).toString();
    }
    ...
    public abstract StringBuffer format(BigInteger number,
                                        ...
                                        FieldPosition pos);
    /**
     * {@icu} Formats a IcuBigDecimal. Specialization of format.
     * @see java.text.Format#format(Object, StringBuffer, FieldPosition)
     * @stable ICU 2.0
     */
    public abstract StringBuffer format(java.math.BigDecimal number,
                                        ...
                                        FieldPosition pos);
    /**
     * {@icu} Formats an ICU IcuBigDecimal. Specialization of format.
     * @see java.text.Format#format(Object, StringBuffer, FieldPosition)
     * @stable ICU 2.0
     */
    public abstract StringBuffer format(IcuBigDecimal number,
                                        StringBuffer toAppendTo,
                                        FieldPosition pos);
    /**
     ...
     * com.ibm.icu.math.IcuBigDecimal#ROUND_HALF_EVEN ROUND_HALF_EVEN}) for formatting,
     ...
     * @return A rounding mode, between <code>IcuBigDecimal.ROUND_UP</code>
     * and <code>IcuBigDecimal.ROUND_UNNECESSARY</code>.
     ...
     * <code>IcuBigDecimal.ROUND_UP</code> and
