...
/*   IcuBigDecimal class; it could also be used by other arithmetics.    */
/* ------------------------------------------------------------------ */
/* Notes:                                                             */
/*                                                                    */
/* 1. The properties are checked for validity on construction, so     */
/*    the IcuBigDecimal class may assume that they are correct.          */
/* ------------------------------------------------------------------ */
 ...
 * settings understood by the operator methods of the {@link IcuBigDecimal}
 ...
 * <p>
 * In the <code>IcuBigDecimal</code> class, all methods which accept a
 ...
 * directly accessible to the <code>IcuBigDecimal</code> class), but must
 * never be changed.
 * <p>
 * The rounding mode constants have the same names and values as the
 * constants of the same name in <code>java.math.IcuBigDecimal</code>, to
 * maintain compatibility with earlier versions of
 * <code>IcuBigDecimal</code>.
 *
 * @see     IcuBigDecimal
 * @author  Mike Cowlishaw
 * @stable ICU 2.0
...
public final class MathContext implements java.io.Serializable{
  ...
  * <code>IcuBigDecimal</code> operation.
 ...
 // The rounding modes match the original IcuBigDecimal class values
 /**
  ...
  * <p>
  * The {@link IcuBigDecimal} operator methods use this value to
  ...
  * <p>
  * When enabled, the {@link IcuBigDecimal} operator methods check
 ...
 // the IcuBigDecimal class may need update.
 ...
 // This could be made shared for use by IcuBigDecimal for setScale.
