...
public final class UniversalTimeScale
{
     ...
     * All calculations are done using <code>IcuBigDecimal</code> to guarantee that the value
     ...
     * @stable ICU 3.2
     */
    public static IcuBigDecimal bigDecimalFrom(double otherTime, int timeScale)
    {
        TimeScaleData data     = getTimeScaleData(timeScale);
        IcuBigDecimal other       = new IcuBigDecimal(String.valueOf(otherTime));
        IcuBigDecimal units       = new IcuBigDecimal(data.units);
        IcuBigDecimal epochOffset = new IcuBigDecimal(data.epochOffset);
     ...
     * @stable ICU 3.2
     */
    public static IcuBigDecimal bigDecimalFrom(long otherTime, int timeScale)
    {
        TimeScaleData data     = getTimeScaleData(timeScale);
        IcuBigDecimal other       = new IcuBigDecimal(otherTime);
        IcuBigDecimal units       = new IcuBigDecimal(data.units);
        IcuBigDecimal epochOffset = new IcuBigDecimal(data.epochOffset);
    ...
    /**
     * Convert a <code>IcuBigDecimal</code> datetime from the given time scale to the universal time scale.
     * All calculations are done using <code>IcuBigDecimal</code> to guarantee that the value
     * does not go out of range.
     *
     * @param otherTime The <code>IcuBigDecimal</code> datetime
     * @param timeScale The time scale to convert from
     * 
     * @return The datetime converted to the universal time scale
     *
     * @stable ICU 3.2
     */
    public static IcuBigDecimal bigDecimalFrom(IcuBigDecimal otherTime, int timeScale)
    {
        TimeScaleData data = getTimeScaleData(timeScale);
    ...
    /**
     * Convert a datetime from the universal time scale stored as a <code>IcuBigDecimal</code> to a
    ...
    /**
     * Convert a datetime from the universal time scale to a <code>IcuBigDecimal</code> in the given time scale.
     *
     * @param universalTime The datetime in the universal time scale
     * @param timeScale The time scale to convert to
     * 
     ...
     * @stable ICU 3.2
     */
    public static IcuBigDecimal toBigDecimal(long universalTime, int timeScale)
    {
        TimeScaleData data     = getTimeScaleData(timeScale);
        IcuBigDecimal universal   = new IcuBigDecimal(universalTime);
        IcuBigDecimal units       = new IcuBigDecimal(data.units);
        IcuBigDecimal epochOffset = new IcuBigDecimal(data.epochOffset);
        
        return universal.divide(units, IcuBigDecimal.ROUND_HALF_UP).subtract(epochOffset);
    }
     ...
     * @stable ICU 3.2
     */
    public static IcuBigDecimal toBigDecimal(IcuBigDecimal universalTime, int timeScale)
    {
        TimeScaleData data     = getTimeScaleData(timeScale);
        IcuBigDecimal units       = new IcuBigDecimal(data.units);
        IcuBigDecimal epochOffset = new IcuBigDecimal(data.epochOffset);
        
        return universalTime.divide(units, IcuBigDecimal.ROUND_HALF_UP).subtract(epochOffset);
    }
     ...
     * @deprecated This API is ICU internal only.
     */
    public static IcuBigDecimal toBigDecimalTrunc(IcuBigDecimal universalTime, int timeScale)
    {
        TimeScaleData data = getTimeScaleData(timeScale);
        IcuBigDecimal units = new IcuBigDecimal(data.units);
        IcuBigDecimal epochOffset = new IcuBigDecimal(data.epochOffset);
        
        return universalTime.divide(units, IcuBigDecimal.ROUND_DOWN).subtract(epochOffset);
    }
}
